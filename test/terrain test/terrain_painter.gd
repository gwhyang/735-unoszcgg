...
@export var noise_scale_1:float = 0.2
@export var noise_frequency_1:float = 0.025
@export var noise_scale_2:float = 0.05
@export var noise_frequency_2:float = 0.1
@export var noise_scale_3:float = 0.09
@export var noise_frequency_3:float = 0.18
